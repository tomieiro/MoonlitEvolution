...
function Main()
    ...
    popValue = fl.int_input(280, 200, 60, 30, "TAM POPULACAO  ")
    EnvValue = fl.int_input(280, 250, 60, 30, "TAM AMBIENTE   ")
    MutValue = fl.float_input(280, 300, 60, 30, "TX MUTACAO     ")
    confirmaPop = fl.button(390, 250, 60, 30, "OK")
    bAuto = fl.toggle_button(260, 360, 100, 30, "Automatico")
